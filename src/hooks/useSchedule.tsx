...
import { getAvailableTimeSlotsForDay as getAvailableSlots, getAppointmentsForDay } from '@/utils/scheduleUtils';
...
export const useSchedule = () => {
  ...
  const availableTimeSlots = useMemo(() => 
    selectedDate ? getAvailableSlots(APPOINTMENTS, selectedDate) : [],
  [selectedDate]);
  
  // Define getAvailableTimeSlotsForDay as a memoized function that calls the imported utility
  const getAvailableTimeSlotsForDay = useCallback((date: Date) => {
    return getAvailableSlots(APPOINTMENTS, date);
  }, []);
